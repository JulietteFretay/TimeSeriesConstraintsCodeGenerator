...
public class TestFootprint {
	...
	public static void main(String[] args) {
		...
		bump_on_decreasing_sequence.getResultForATimeSerie(serie,null,0);
		...
		decreasing_sequence.getResultForATimeSerie(serie,null,0);
		...
		decreasing_terrace.getResultForATimeSerie(serie,null,0);
		...
		decreasing.getResultForATimeSerie(serie,null,0);
		...
		dip_on_increasing_sequence.getResultForATimeSerie(serie,null,0);
		...
		gorge.getResultForATimeSerie(serie,null,0);
		...
		increasing_sequence.getResultForATimeSerie(serie,null,0);
		...
		increasing_terrace.getResultForATimeSerie(serie,null,0);
		...
		inflexion.getResultForATimeSerie(serie,null,0);
		...
		plain.getResultForATimeSerie(serie,null,0);
		...
		plateau.getResultForATimeSerie(serie,null,0);
		...
		proper_plain.getResultForATimeSerie(serie,null,0);
		...
		proper_plateau.getResultForATimeSerie(serie,null,0);
		...
		steady_sequence.getResultForATimeSerie(serie,null,0);
		...
		steady.getResultForATimeSerie(serie,null,0);
		...
		strictly_decreasing_sequence.getResultForATimeSerie(serie,null,0);
		...
		strictly_increasing_sequence.getResultForATimeSerie(serie,null,0);
		...
		summit.getResultForATimeSerie(serie,null,0);
		...
		valley.getResultForATimeSerie(serie,null,0);
		...
		zigzag.getResultForATimeSerie(serie,null,0);
	}
}
